...
if(isset($_POST['submit'])){
 ...
 //$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
  ...
  //if( in_array($imageFileType,$extensions_arr) ){
     ...
     $query = "UPDATE joe.products SET category = '$category' WHERE type = '$type';UPDATE joe.products SET quantity = (quantity -'$quantity') 
     ...
     //move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name);
          echo '<p style="text-align:center;"><img src="../images/uploaded.png" style ="width:300px; height:300px; text-align:center;"><br>';
           echo "Stock saved.<br>";
           echo '<a href="../removestock.php">Back</a></p>';
