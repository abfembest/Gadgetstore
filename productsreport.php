...
<center>
        ...
        <div style="max-width: 1000px; margin-top: 4px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="reportpage.php"><button class="btn btn-info">Back</button></a> <b>Product reports for today  <span id="span1"><script type="text/javascript">
                var dat = new Date();
  ...
  echo "<tr>";
  echo "<th>TOTAL QUANTITY OF ITEMS IN STOCK:&nbsp </th><td><b>".($qinstock)."</b></td>
  <th>TOTAL VALUE OF THE STOCK</th>
          <td><b>#".($total_cost)."</b></td>";
  
  echo "</tr>";
  echo "<tr>";
  echo "<th>TOTAL TYPES OF ITEMS IN STOCK </th><td><b>".($items)."</b></td></td>";
  echo "</tr>";
  echo "<tr>";
