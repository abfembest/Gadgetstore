    ...
    <body style=" font-size: 15px;text-align: center; font-style: bold;"><b>
        ...
        <div class="ticket">
          <div style="background-color: pink;" class="hidden-color">
              <form action="" method="POST" class="hidden-print"><input type="text" name="invoice_id" class="      btn btn-info">
                    <button name="search" id="submit1" class="btn btn-info" value="search" onclick="show()">Search<i class="fa fa-search"></i></button>       
              </form>
