        ...
        <div style="max-width: 1000px;margin-top: 3px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="reportpage.php"><button class="btn btn-info">Back</button></a> <b>Sales reports for today  <span id="span1"><script type="text/javascript">
                var dat = new Date();
    ...
    //$produce = $_POST['produce'];
     // formating the dates
      ...
      $date2 = $date->format('Y-m-d');
          ...
          $sql ="SELECT product, specie, SUM(quantity) as qsold, SUM(unit_price) AS price, transaction_date, SUM(quantity*unit_price) as value
            FROM joe.sales WHERE transaction_date BETWEEN '$dat1' AND '$dat2' GROUP BY transaction_date, specie";
