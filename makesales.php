                ...
                <h3 class="card-title">
                  <form action="" method="POST">  
                      ...
                      <span class="form-inline"><label>Products:&nbsp&nbsp&nbsp</label>
                        <select  id="product" name="product" required="required" class="form-control select2">
                        <?php
                    ...
                    <label class="form-inline" style="padding-left: 10px;">Current sales
                        <?php
                            $query = "SELECT quantity, unit_price, SUM(quantity*unit_price) AS currentsale, transaction_date FROM joe.sales WHERE transaction_date = current_date";
                            $result = mysqli_query($connect, $query);    
                            while ($row = mysqli_fetch_array($result)){
                  ...
                  <!--<input type="text" name="total_instock" value="<?php #echo $row['total'];  ?> ">-->
                    ...
                    <div class="col-sm-8">
                      <div>
                        ...
                        <?php
                            $query = "SELECT category, type, quantity FROM joe.products WHERE category ='$product'";
                            $result = mysqli_query($connect, $query);    
                            while ($row = mysqli_fetch_array($result)){
  ...
  ?>
    ...
    <div class="col-md-10">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <a href="actions/action_refresh.php" style="float: right;"> <input type="button" name="refresh" value="Complete sales" class="btn btn-danger"> 
                  </a>
