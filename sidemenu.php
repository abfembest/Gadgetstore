 ...
 <aside class="main-sidebar sidebar-dark-olive" style="font-size: 20px;">
    ...
    <a href="front.php" class="brand-link">
      <!--<img src="dist/img/" alt="Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">-->
      <span class="brand-text font-weight-bold" style="font-size: 14px; font-weight: bolder; font-family: sans-serif;">UNCLE JOE COMPANY LIMITED</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="makesales.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="newstocks.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New stock</p>
                </a>
              </li>
